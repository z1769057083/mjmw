<template>
  <div class="confirm-wrap" :class="{'maskMainActive': isAndroidCss}">
    <!-- 头部信息 -->
    ...
    <div class="foot-wrap">
      <div class="left" v-if="(total - mjb + express * 1) == 0">实际付款：<i class="ic_mj"></i>{{mjb.toFixed(2)}}</div>
      <div class="left" v-else>实际付款：￥{{ (total - mjb + express * 1).toFixed(2) }}</div>
