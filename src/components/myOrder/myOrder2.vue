        ...
        <div>
          ...
          <div class="alert" v-show="noroder">
            ...
            <div class="cont">
              ...
              <router-link :to="{ name: 'home' }" tag="a" class="btn">去逛逛</router-link>
            </div>
          </div>
          <!-- 列表 -->
          <!--title-->
...
//        }
    ...
    mounted() {
      this.ited = window.location.search;
      console.log(this.ited);
      if (this.ited === '?type=1') {
        this.norder = true;
        this.uscom = false;
        this.nolis = 0;
        this._indexAjax(1); // 待付款
      } else if (this.ited === '?type=0') {
        this._indexAjax(0); // 全部
      } else if (this.ited === '?type=3') {
        this.norder = true;
        this.uscom = false;
        this.nolis = 2;
        this._indexAjax(3); // 待收货
      } else if (this.ited === '?type=2') {
        this.norder = true;
        this.uscom = false;
        this.nolis = 1;
        this._indexAjax(2); // 待发货
      } else if (this.ited === '?type=5') {
        this.norder = false;
        this.uscom = true;
        this.com = 0;
        this._indexAjax(5); // 待评价
