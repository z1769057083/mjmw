<template>
  <div class="payment-wrap">
    ...
    <header class="head-wrap">
      <router-link class="back pos" :to="{name: 'home'}" replace></router-link>
      <p class="txt">支付</p>
    </header>
    <div class="main" ref="scroll_hook">
      <div class="scroll-wrap">
        ...
        <div class="alert alert-password">
          ...
          <div class="cont">
            <div class="zw-10"></div>
            <div class="txt">支付成功！<br>系统正在处理您的订单</div>
            <router-link class="btn btn-sure" :to="{name: 'home', params: { back: true }}" replace>返回首页</router-link>
          </div>
        </div>
      </div>
    </div>
