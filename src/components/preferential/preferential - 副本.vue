<template>
  <div class="preferential-wrap">
        ...
        <div class="list-item" v-for="(item, index) in list">
          <div class="title">
            <div class="left" @click="toggleChecked(item)"><span class="btn" :class="{on: item.checked}"></span><span
              class="txt">{{'优惠组合' + (index + 1)}}</span></div>
          ...
          <div class="cart">
            ...
            <div class="right">
              ...
              <span class="btn" @click="add(item)"></span>
            </div>
          </div>
        </div>
      </div>
    ...
    <footer class="foot-wrap">
      ...
      <div class="price">合计<span class="num">{{'￥' + checkedMoney}}</span></div>
    ...
    watch: {
      list: {
        handler() {
          ...
          this.checkedNum = num;
          this.checkedMoney = money.toFixed(2);
        },
        deep: true
      }
    }
